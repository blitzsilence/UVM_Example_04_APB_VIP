...
class apb_socreboard extends uvm_scoreboard;
	...
	virtual function void build_phase(uvm_phase phase);
		...
		m_comp = uvm_in_order_class_comparator#(apb_transaction)::type_id::create("m_comp", this);
	...
	virtual function void extract_phase(uvm_phase phase);
		...
		uvm_config_db#(int unsigned)::set(null, "uvm_test_top.env", "matches", m_comp.m_matches);
		uvm_config_db#(int unsigned)::set(null, "uvm_test_top.env", "mis_matches", m_comp.m_mismatches);
	endfunction
